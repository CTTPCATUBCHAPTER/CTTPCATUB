...
const About = () => {
  ...
  return (
   ...
   <Helmet>
  <title>About | Christ to the Philippines - Catub Chapter</title>
  <meta
    name="description"
    content="Learn about Christ to the Philippines - Catub Chapter, our mission, vision, beliefs, and leadership team dedicated to spreading the Gospel in the Philippines."
  />
  <meta
    name="keywords"
    content="Catub chapter, cttp, catub, cttp catub, catub church, cttp catub chapter, christ to the philippines, catub, christ to the philippines - catub chapter, catub church, CTTP CATUB, Cttp, cttp catub church, church, Philippines, worship, ministry, events, youth, children, outreach"
  />
  <meta name="author" content="Christ to the Philippines - Catub Chapter" />

  {/* Open Graph tags */}
  <meta property="og:title" content="About | Christ to the Philippines - Catub Chapter" />
  <meta
    property="og:description"
    content="Learn about Christ to the Philippines - Catub Chapter, our mission, vision, beliefs, and leadership team dedicated to spreading the Gospel in the Philippines."
  />
  <meta property="og:type" content="website" />
  <meta property="og:url" content="https://cttpcatubchapter.com/about" />
</Helmet>
